...
const FamilyRegistration: React.FC<FamilyRegistrationProps> = ({
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="bg-amber-50 dark:bg-gray-800/50 border-l-4 border-amber-500 p-4 rounded-md mb-6">
        ...
        <div className="flex-shrink-0">
          ...
          <div className="ml-3">
        <h3 className="text-lg font-medium text-amber-800 dark:text-amber-300">Important Notice: Family Package Eligibility</h3>
        <div className="mt-2 text-sm text-amber-700 dark:text-amber-200">
          ...
          <p className="mt-3 font-medium">Pricing varies based on each member's age category.</p>
        </div>
          </div>
        </div>
      </div>
